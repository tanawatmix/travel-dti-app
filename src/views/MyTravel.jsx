  ...
  useEffect(() => {
    ...
    const getAllTravel = async () => {
      ...
      const resData = await axios.get(
        `travel-service-server-by-prisma-cpbu.vercel.app/travel/${traveller.travellerId}`
      );
            ...
            <Toolbar>
              ...
              <Avatar
                src={
                  travellerImage === ""
                    ? Profile
                    : `travel-service-server-by-prisma-cpbu.vercel.app/images/traveller/${travellerImage}`
                }
              />
              <Link
                to={"/"}
